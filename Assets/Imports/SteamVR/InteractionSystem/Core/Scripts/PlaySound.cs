...
namespace Valve.VR.InteractionSystem
{
	...
	public class PlaySound : MonoBehaviour
	{
		...
		//-------------------------------------------------
		public AudioClip PlayOneShotSound(int index)
		{
		...
		//-------------------------------------------------
		public AudioClip PlayLooping(int index)
		{
		...
		//-------------------------------------------------
		private void SetAudioSource(int index)
		{
			...
			if ( this.waveFile.Length > 0  )
			{
				...
				if(index < 0){
					...
					audioSource.clip = this.waveFile[index];
					clip = audioSource.clip;
				}
			}
		}
